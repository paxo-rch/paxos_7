...
#define LGFX_PRINTF_ENABLED
  ...
  public:
    ...
    LGFX_INLINE void drawRoundRectWithBorder( int32_t x, int32_t y, int32_t w, int32_t h, int32_t radius, int32_t borderSize, uint16_t backgroundColor, uint16_t borderColor ){ fillRoundRect(x, y, w, h, radius, borderColor); fillRoundRect(x+borderSize, y+borderSize, w-borderSize, h-borderSize, radius, backgroundColor);}
