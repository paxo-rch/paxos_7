...
void TFT_eSPI::drawRoundRectWithBorder(int32_t x, int32_t y, int32_t w, int32_t h, int32_t r, uint8_t borderSize, uint32_t color, uint32_t borderColor)
{
  //begin_tft_write();          // Sprite class can use this function, avoiding begin_tft_write()
  inTransaction = true;
  
  fillRoundRect(x, y, w, h, r, borderColor);
  fillRoundRect(x + borderSize, y + borderSize, w - borderSize*2, h - borderSize*2, r, color);
