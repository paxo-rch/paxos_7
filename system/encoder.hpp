...
{
    public:
    String convertEncodedCharToChar(int chr);
    int HexCharToDecimal(char chr);
    String HexStringToString(String str);
};

String Encoder::convertEncodedCharToChar(int chr)
{
    switch (chr)
    {
        case 225: return "a";
...
String Encoder::HexStringToString(String str)
{
    String result = "";
    ...
    for (int i = 0; i + 3 < str.length(); i+=4)
    {
        ...
        Serial.println("char " + String(i/4) + " : " + String(char(str[i]))+String(char(str[i+1]))+String(char(str[i+2]))+String(char(str[i+3])) + " : " + String(HexCharToDecimal(str[i])) + "," + String(HexCharToDecimal(str[i+1])) + "," + String(HexCharToDecimal(str[i+2])) + "," + String(HexCharToDecimal(str[i+3])) + " : " + String(chr));
